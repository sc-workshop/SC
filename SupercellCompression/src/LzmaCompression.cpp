...
namespace sc
{
	CompressionError LZMA::decompressStream(CLzmaDec* state, SizeT unpackSize, IBinaryStream& inStream, IBinaryStream& outStream)
	{
	...
	CompressionError LZMA::decompress(IBinaryStream& inStream, IBinaryStream& outStream)
	{
		CLzmaDec state;
	...
	CompressionError LZMA::compress(IBinaryStream& inStream, IBinaryStream& outStream)
	{
		CLzmaEncHandle enc;
		SRes res;
		CLzmaEncProps props;
