...
class SWFTexture(Writable):
    ...
    def save(self, has_external_texture: bool):
        ...
        if self.channels == 4 and (self.pixel_format, self.pixel_internal_format) != (
        "GL_LUMINANCE_ALPHA", "GL_LUMINANCE8_ALPHA8"):
        ...
        elif self.channels == 4 and (self.pixel_format, self.pixel_internal_format) == (
        "GL_LUMINANCE_ALPHA", "GL_LUMINANCE8_ALPHA8"):  # OpenCV doesn't support LUMINANCE_ALPHA :(((
