...
class DOMSymbolItem:
    def __init__(self, name: str = None, symbol_type: str = None) -> None:
        # attributes
        self.name = name
        self.item_id: str or None = None
        self.symbol_type = symbol_type

        self.scale_grid_left: float or None = None
        self.scale_grid_top: float or None = None
        self.scale_grid_right: float or None = None
        self.scale_grid_bottom: float or None = None
